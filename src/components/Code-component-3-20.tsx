...
interface MarketplaceProps {
  ...
  onBuyCredits: (quantity: number, price: number, seller: string) => boolean;
...
export const Marketplace: React.FC<MarketplaceProps> = ({ 
  ...
  const handleBuyCredits = (listing: any) => {
    const success = onBuyCredits(listing.quantity, listing.price, listing.seller);
    if (success) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-gray-900 mb-2">Carbon Credit Marketplace</h1>
